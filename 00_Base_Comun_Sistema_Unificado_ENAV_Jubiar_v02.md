...
**Cambios respecto de la v0.1:** se incorpora el mapa completo de módulos (turnos, cosecha, descarga de camiones, bot de consulta, declaración jurada), la identidad de terceros externos y el capítulo de instrucciones de construcción.
...
| # | Módulo | Qué resuelve | Proyecto donde se releva |
|---|---|---|---|
| 0 | **Base transversal** | Identidad, conexión, firma, bitácora | Base |
| 1 | **RRHH / Higiene y Seguridad** | Legajos, EPP, licencias médicas, reclutamiento | RRHH |
| 2 | **Turnos y asistencia** | Turnos rotativos, novedades, sincronización Time ↔ Nexus | RRHH (con insumo de Producción) |
| 3 | **Cosecha y personal temporario** | Alta masiva estacional, corresponsabilidad gremial, EPP de temporarios | Productivo + RRHH |
| 4 | **Descarga de camiones** | Recepción de uva: pesaje, romaneo, productor, transportista | Productivo |
| 5 | **Bot de consulta** | Consulta externa del estado de descargas | Productivo |
| 6 | **Declaración jurada** | Formulario declarativo con firma y resguardo legal | A definir (ver §7) |
