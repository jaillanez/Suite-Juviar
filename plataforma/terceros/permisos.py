"""Permisos por tarea de un contacto sobre un CUIT."""
...
POR_DEFECTO_INVITADO = frozenset({VER_INFORMES})
POR_DEFECTO_IMPORTADO = TAREAS
...
def puede(tareas: frozenset[str], tarea: str) -> bool:
    return tarea in tareas
