...
export type Perfil = "RRHH" | "MEDICO" | "HYS" | "COMPRAS" | "SUPERVISOR" | "BODEGA";
export type Seccion = "inicio" | "epp" | "analitica" | "seleccion" | "capacitaciones" | "legajo" | "salud" | "turnos" | "contactos";
...
export const perfiles: Record<Perfil, { nombre: string; secciones: Seccion[] }> = {
  ...
  BODEGA: { nombre: "Administración de bodega", secciones: ["inicio", "contactos"] },
};
...
export const nombres: Record<Seccion, string> = {
  ...
  contactos: "Contactos de productores",
};
